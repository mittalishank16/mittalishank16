# Hi, I’m Ishank Mittal

I build data-driven systems using machine learning, deep learning, and generative AI to solve real-world problems.
My work applies statistical analysis, modeling, and experimentation to turn data into insights that inform product and business decisions.

---

## Core Focus

- Applied data science and machine learning for real-world use cases
- Data analysis, feature engineering, and model evaluation
- Exploring deep learning and generative AI use cases
- Human-centered problem framing using UX research and behavioral insights
